...
export type AccountCategoryEnum =
  (typeof ACCOUNT_CATEGORY_MAPPINGS)[AccountCategoryDisplay];

/**
 * Convert UI display category name to Prisma enum value
 */
export function mapDisplayCategoryToEnum(
  displayCategory: string,
): AccountCategoryEnum | null {
  return (
    ACCOUNT_CATEGORY_MAPPINGS[displayCategory as AccountCategoryDisplay] || null
  );
}
