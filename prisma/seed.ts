...
async function main() {
  ...
  // Asset accounts
  const assetAccounts = [
    { kode: "1001", nama: "Kas", tipe: "ASSET", kategori: "CURRENT_ASSET", deskripsi: "Kas dan setara kas" },
    { kode: "1002", nama: "Piutang Dagang", tipe: "ASSET", kategori: "CURRENT_ASSET", deskripsi: "Piutang dari penjualan" },
    { kode: "1003", nama: "Persediaan Barang", tipe: "ASSET", kategori: "CURRENT_ASSET", deskripsi: "Persediaan barang dagang" },
    { kode: "1101", nama: "Peralatan Toko", tipe: "ASSET", kategori: "FIXED_ASSET", deskripsi: "Peralatan dan mesin toko" },
    { kode: "1102", nama: "Akumulasi Penyusutan", tipe: "ASSET", kategori: "FIXED_ASSET", deskripsi: "Akumulasi penyusutan aktiva tetap" },
  ]

  // Liability accounts
  const liabilityAccounts = [
    { kode: "2001", nama: "Hutang Dagang", tipe: "LIABILITY", kategori: "CURRENT_LIABILITY", deskripsi: "Hutang pembelian" },
    { kode: "2002", nama: "Hutang Pajak", tipe: "LIABILITY", kategori: "CURRENT_LIABILITY", deskripsi: "Hutang pajak yang belum dibayar" },
  ]

  // Equity accounts
  const equityAccounts = [
    { kode: "3001", nama: "Modal Pemilik", tipe: "EQUITY", kategori: "OWNER_EQUITY", deskripsi: "Modal yang disetor pemilik" },
    { kode: "3002", nama: "Laba Ditahan", tipe: "EQUITY", kategori: "RETAINED_EARNINGS", deskripsi: "Laba yang ditahan dalam perusahaan" },
  ]

  // Revenue accounts
  const revenueAccounts = [
    { kode: "4001", nama: "Pendapatan Penjualan", tipe: "REVENUE", kategori: "OPERATING_REVENUE", deskripsi: "Pendapatan dari penjualan barang" },
    { kode: "4002", nama: "Pendapatan Lain-lain", tipe: "REVENUE", kategori: "OTHER_REVENUE", deskripsi: "Pendapatan selain penjualan utama" },
  ]

  // Expense accounts
  const expenseAccounts = [
    { kode: "5001", nama: "Harga Pokok Penjualan", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya pembelian barang yang dijual" },
    { kode: "5002", nama: "Gaji Karyawan", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Gaji dan tunjangan karyawan" },
    { kode: "5003", nama: "Biaya Listrik", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya listrik dan utilitas" },
    { kode: "5004", nama: "Biaya Sewa", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya sewa tempat usaha" },
    { kode: "5005", nama: "Biaya ATK", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya alat tulis kantor" },
    { kode: "5006", nama: "Biaya Transportasi", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya transportasi dan perjalanan" },
    { kode: "5007", nama: "Biaya Perbaikan", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya perbaikan dan pemeliharaan" },
    { kode: "5008", nama: "Biaya Iklan & Promosi", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya iklan dan promosi" },
    { kode: "5009", nama: "Biaya Pajak", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya pajak dan retribusi" },
    { kode: "5010", nama: "Biaya Asuransi", tipe: "EXPENSE", kategori: "OPERATING_EXPENSE", deskripsi: "Biaya asuransi dan premi" },
    { kode: "5011", nama: "Biaya Lain-lain", tipe: "EXPENSE", kategori: "OTHER_EXPENSE", deskripsi: "Biaya operasional lainnya" },
  ]
  ...
  const categories = [
    "Bahan Pokok", "Minuman", "Snack", "Bumbu Dapur", "Produk Susu",
    "Produk Beku", "Makanan Kaleng", "Kesehatan & Kecantikan",
    "Peralatan Rumah Tangga", "Elektronik", "Pakaian", "Mainan",
    "Buku & Alat Tulis", "Olahraga", "Otomotif"
  ]
  ...
  const productTemplates = {
    "Bahan Pokok": [
      ...
      { name: "Susu Kental Manis", unit: "kaleng", basePrice: 12000, markup: 1.3 },
    ...
    "Peralatan Rumah Tangga": [
      ...
      { name: "Pewangi Ruangan", unit: "botol", basePrice: 22000, markup: 1.35 }
    ],
    "Elektronik": [
    ...
    "Pakaian": [
      ...
      { name: "Sepatu Sneakers", unit: "pasang", basePrice: 250000, markup: 1.2 },
    ...
    "Olahraga": [
      ...
      { name: "Raket Badminton", unit: "buah", basePrice: 200000, markup: 1.25 },
      ...
      { name: "Sepatu Olahraga", unit: "pasang", basePrice: 300000, markup: 1.25 }
    ],
    "Otomotif": [
  ...
  for (let i = 0; i < 1000; i++) {
    ...
    // Generate variations
    const variations = ["Premium", "Regular", "Ekonomis", "Super", "Extra", "Plus", "Max", "Pro"]
    const brands = ["ABC", "XYZ", "Super", "Best", "Top", "Prima", "Elite", "Gold"]
    const sizes = ["Kecil", "Sedang", "Besar", "Jumbo", "Mini", "Large", "Small"]
    ...
    const hargaJual = Math.round(hargaBeli * template.markup * (0.95 + Math.random() * 0.1)) // Add some markup variation
